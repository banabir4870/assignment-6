    ...
    return (
        <div className='w-8/12 mx-auto mt-32 space-y-4'>
            ...
            <div className="tabs tabs-box justify-center bg-transparent">
                ...
                <input onClick={()=>setActiveTab('cart')}  type="radio" name="my_tabs_1" className={`tab rounded-full w-40 font-bold ${activeTab === 'cart' ? 'bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white' : ''}`} aria-label={`Cart (0)`} />
            </div>
        </div>
    );
};
