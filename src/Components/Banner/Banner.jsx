    ...
    return (
        <div className='w-11/12 md:w-8/12 mx-auto my-14 md:flex justify-between items-center'>
            <div className='space-y-4 text-center md:text-left'>
                ...
                <h1 className=' text-4xl lg:text-5xl xl:text-7xl font-extrabold'>Supercharge Your <br /> <span className='bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent'>Digital Workflow</span></h1>
                ...
                <div className='flex gap-4 items-center justify-center md:justify-start'>
                    ...
                    <button className='flex items-center gap-1 btn btn-outline btn-primary rounded-full font-bold'><MdOutlinePlayArrow />Watch Demo</button>
                </div>
